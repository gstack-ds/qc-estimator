...
- **Callouts v1 is FULLY LIVE in prod** — migration 048 run + verified end-to-end by Gary (raised a test callout, confirmed it does NOT leak onto the deck). Nothing pending. Rollback commit for the callouts deploy = **3103d54** (kept for reference only).
