...
### Next Session Start
- Migration 045 committed to main — **run it in Supabase before testing in production**.
- 722 tests passing (733 − 11 vendorMerge tests that were deleted).
...
- Export filtering: proposal generation and all exports should skip estimates where included_in_proposal = false — not yet implemented (data model is ready).
