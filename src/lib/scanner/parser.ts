...
Return ONLY valid JSON with these exact field names (all optional, use null if not found):
{
  ...
  "lead_source": "where the lead came from — use exactly one of: GDP, Direct, Rubra, Conference, Sales Coordinator (or null)",
  "source_advisor": "GDP advisor first name only (e.g. Shelley, Riley, Chris, Benoit, Dawn, Maxine)",
  "source_coordinator": "GDP coordinator first name only (e.g. Amy, Maria, Jessica, Michelle, Maxime)",
